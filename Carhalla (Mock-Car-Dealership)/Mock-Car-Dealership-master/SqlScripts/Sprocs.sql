...
AS
BEGIN
	SELECT c.ModelYear AS "Year", c.IsNew AS "IsNew", c.MSRP * c.UnitsInStock AS "StockValue", c.IsSold AS "IsSold",
	...
	FROM Cars c
		...
		Group By ModelYear, IsNew, MakeName, ModelName, MSRP, UnitsInStock, IsSold
END
