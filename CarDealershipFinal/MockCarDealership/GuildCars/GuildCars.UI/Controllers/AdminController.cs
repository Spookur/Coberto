...
namespace GuildCars.UI.Controllers
{
    public class AdminController : Controller
    {
        ...
        public ActionResult Makes()
        {
            ...
            make.MakeName = _makeRepo.GetAll();
        ...
        public ActionResult Models()
        {
            ...
            model.Models = _modelRepo.GetAll();
        ...
        [Authorize(Roles = "Admin")]
        [AcceptVerbs("Post")]
        public ActionResult Makes(MakeViewModel make)
        {
            if (ModelState.IsValid)
            {
                Make newMake = new Make()
                {
                    MakeName = make.MakeName.ToString(),
                    AddedBy = make.AddedBy,
        ...
        {
            SpecialViewModel special = new SpecialViewModel();
            special.Specials = _specialsRepo.GetAll();
