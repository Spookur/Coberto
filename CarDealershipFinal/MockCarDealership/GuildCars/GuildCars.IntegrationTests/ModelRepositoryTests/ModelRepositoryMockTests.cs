...
namespace GuildCars.IntegrationTests.ModelRepositoryTests
{
    ...
    public class ModelRepositoryMockTests
    {
        ...
        public void CanGetAllModels()
        {
            ...
            Assert.AreEqual(Models[2].ModelName, "Mustang");
            Assert.AreEqual(Models[2].DateAdded, new DateTime(2020, 1, 1));
        }
        ...
        public void CanGetModelById()
        {
            ...
            Assert.AreEqual(Model.ModelName, "Mustang");
            Assert.AreEqual(Model.DateAdded, new DateTime(2020, 1, 1));
        }
