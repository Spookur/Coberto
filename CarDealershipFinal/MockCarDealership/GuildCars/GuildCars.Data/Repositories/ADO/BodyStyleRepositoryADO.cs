...
namespace GuildCars.Data.Repositories.ADO
{
    ...
    {
        public IEnumerable<BodyStyle> GetAll() //  method to get enumerable selection of all body styles
        {
            List<BodyStyle> BodyStyles = new List<BodyStyle>(); // create a list of bodystyles

            using (var dbConnection = new SqlConnection(Settings.GetConnectionString())) // connection string from settings class
            {
                try
                {
