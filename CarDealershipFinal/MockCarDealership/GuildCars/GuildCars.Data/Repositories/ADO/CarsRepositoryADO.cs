        ...
        public IEnumerable<Car> GetAllCars()
        {
            ...
            using (var dbConnection = new SqlConnection(Settings.GetConnectionString()))
            {
                try
                {
                    ...
                    using (SqlDataReader dr = cmd.ExecuteReader()) // build the data reader
                    {
                        while (dr.Read())
                        {
                            Car car = new Car();
                ...
                catch (Exception ex)
                {
                    ...
                    dbConnection.Close(); // remember to close the db
                }
                return cars;
            }
        }
        ...
        public IEnumerable<FeaturedShortListItem> GetAllFeaturedCars()
        {
            ...
            using (var dbConnection = new SqlConnection(Settings.GetConnectionString()))
            {
                try
                {
                    ...
                    using (SqlDataReader dr = cmd.ExecuteReader()) // builds data reader
                    {
                        while (dr.Read())
                        {
                ...
                catch (Exception ex)
                {
                    ...
                    dbConnection.Close(); // always make sure to close the db
                }
                return featuredCars;
            }
        }
